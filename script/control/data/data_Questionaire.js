function fnGetCollectDataQuestionaire (data) {
    ...
    if (data == 'branchpersonal') {
        str = [
            ...
            // -------------------------- 2 -------------------------- //
            { id: 201, id_control: '2.',  head_id: 2, mainControl_id: 2 , text: "การศึกษาและฝึกอบรม" , main_Obj:"วัตถุประสงค์ของการควบคุม" , objectName: "เพื่อให้กระบวนงานต่าง ๆ ในกิจกรรมการศึกษาและฝึกอบรมเป็นไปตาม ขั้นตอนสอดคล้องกับระเบียบ ข้อบังคับ หลักเกณฑ์ที่กำหนด และทันต่อเวลา ซึ่งจะทำให้การผลิต และการพัฒนากำลังพลเป็นไปอย่างมีประสิทธิภาพ บังเกิดผลสัมฤทธิ์ต่อการปฏิบัติภารกิจของหน่วยงานและไปอย่างต่อเนื่อง"},
