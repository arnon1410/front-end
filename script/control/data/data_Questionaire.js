...
// -------------------------- 1 -------------------------- //
            ...
            { id: 104, id_control: '1.3', head_id: 1, text: 'การอนุญาตให้บุคลากรเข้าถึงชั้นความลับ โดยยืดหลัก "จำกัดให้ทราบเท่าที่จำเป็น"' , is_subcontrol:0,  ischeckbox:1},
        ...
        str = [
            ...
            { id: 302, id_control: '3.6',  head_id: 3, text: "มีการจัดทำราคากลางเพื่อใช้เป็นฐานสำหรับเปรียบเทียบราคาที่ผู้ยื่นข้อเสนอได้ยื่นเสนอไว้ ที่สามารถจัดซื้อ/จ้างได้จริง" , is_subcontrol:0 , ischeckbox:1 },
            { id: 303, id_control: '3.7',  head_id: 3, text: "การจัดหากระทำโดยหน่วยจัดหา หรือเจ้าหน้าที่พัสดุ ตามใบแจ้งความต้องการพัสดุหรือใบขออนุมัติจัดหาที่ได้รับอนุมัติแล้ว" , is_subcontrol:0 , ischeckbox:1 },
            { id: 304, id_control: '3.8',  head_id: 3, text: "กำหนดให้รวมการจัดซื้อพัสดุคราวละมากๆ" , is_subcontrol:0 , ischeckbox:1 },
            { id: 305, id_control: '3.9',  head_id: 3, text: "มีการจัดทำใบสั่งซื้อและสำเนาให้ผู้เกี่ยวข้อง คือ ผู้ตรวจรับของ ผู้แจ้งจัดหา บัญชีหรือการเงิน ฯลฯ" , is_subcontrol:0 , ischeckbox:1 },
            { id: 306, id_control: '3.10',  head_id: 3, text: "กำหนดหลักเกณฑ์ในการจัดทำสัญญาชัดเจนและรัดกุม" , is_subcontrol:0 , ischeckbox:1 },
            { id: 307, id_control: '3.11',  head_id: 3, text: "รูปแบบสัญญาเป็นไปตามมาตรฐาน กวพ." , is_subcontrol:0 , ischeckbox:1 },
            { id: 302, id_control: '3.12',  head_id: 3, text: "การจัดหาแต่ละขั้นตอนมีการบันทึกในระบบ e-GP ถูกต้องครบถ้วนตามขั้นตอน" , is_subcontrol:0 , ischeckbox:1 },
        ...
        str = [
            // -------------------------- 1.1 -------------------------- //
            // หัวข้อคือเทเบิ้ลหลัก 
            { id: 101, id_control: '1.1',   head_id: 1.1, mainControl_id: 1, text: "การจัดทำยุทธศาสตร์และนโยบายวัตถุประสงค์ของการควบคุม" , main_Obj:"วัตถุประสงค์ของการควบคุม" , objectName: "เพื่อให้มีความมั่นใจว่ายุทธศาสตร์ และนโยบายมีความเหมาะสมกับสภาวการณ์และได้รับการนำไปใช้อย่างถูกต้อง"},
